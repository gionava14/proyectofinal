...
<link rel="stylesheet" href="Consultas.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-gradient u-header u-header" id="sec-7aea"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="skrollable u-align-center u-border-2 u-border-palette-1-base u-clearfix u-image u-parallax u-section-1" id="sec-4765" data-image-width="1200" data-image-height="675">
      <div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">CONSULTA</h1>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="Consultar" style="padding: 10px;" redirect="true">
            <div class="u-form-group u-form-select u-form-group-1">
              <label for="select-4442" class="u-label u-text-palette-1-base u-label-1">Tipo Documento</label>
              <div class="u-form-select-wrapper">
                <select id="select-4442" name="Tipo_Documento" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-39 u-text-palette-1-base u-white u-input-1" required="required">
