...
<html style="font-size: 16px;" lang="es">
  ...
  <body class="u-body"><header class="u-clearfix u-gradient u-header u-header" id="sec-7aea"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="carousel_aa4a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-palette-1-light-1 u-text-1">PASAPORTE COVID</h2>
        <div class="u-align-center u-form u-form-1">
          <form action="Consulta" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="custom" name="Guardar" redirect="true">
            <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-1">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-faf0" name="Tipo" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="required">
            ...
            <div class="u-form-group u-form-name u-form-group-3">
              ...
              <input type="text" placeholder="Nombre y Apellido" id="name-9de0" name="name" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            ...
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-7">
              ...
              <input type="text" placeholder="CENTRO ATENCIÒN" id="name-1d57" name="centro_atencion" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            ...
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-9">
              ...
              <input type="date" placeholder="MM/DD/YYYY" id="date-89b8" name="fecha_prueba" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-10">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-09e6" name="tipo" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="required">
            ...
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-11">
              ...
              <input type="text" placeholder="Lugar de Vacunaciòn" id="name-cb67" name="lugar_vacunacion" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-12">
              ...
              <input type="date" placeholder="MM/DD/YYYY" id="date-0ab5" name="Fecha_Primera_Dosis" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            ...
            <div class="u-align-left u-form-group u-form-submit">
              <a href="Consultas.php" data-page-id="359922106" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-3">GUARDAR</a>
        ...
        <a href="Index.php" data-page-id="766706655" class="u-btn u-btn-round u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-radius-50 u-btn-2">REGRESAR</a>
      </div>
    </section>
